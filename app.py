...
# App Title
st.title("🇧🇪 Belgium Wikipedia Sentiment Analysis")
st.subheader("Powered by Random Forest Classifier")

st.markdown("""
This app analyzes sentiment based on a model trained on Wikipedia content for **Belgium**.
""")

# Default sentence
default_sentence = "Belgium is a beautiful country with great chocolate and amazing architecture."
...
# Footer
st.markdown("---")
st.markdown("📘 Model trained on **Belgium Wikipedia** content using TextBlob + TF-IDF + SMOTE + Random Forest.")
